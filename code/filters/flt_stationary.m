...
arg_define(varargin, ...
    ...
    arg({'numstat','StationaryDim'}, -0.30, [], 'Assumed # of stationary sources. If a negative number is given, it is taken as the assumed number of non-stationary sources.'), ...
